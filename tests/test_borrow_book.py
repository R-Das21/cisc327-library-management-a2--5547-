...
def test_borrow_valid_flow(mocker):
    ...
    mocker.patch("library_service.get_book_by_id", return_value={"id": 1, "title": "1984", "available_copies": 2})
...
def test_borrow_book_not_found(mocker):
    """Book must exist."""
    mocker.patch("library_service.get_book_by_id", return_value=None)
...
def test_borrow_unavailable_book(mocker):
    ...
    mocker.patch("library_service.get_book_by_id", return_value={"id": 2, "title": "1984", "available_copies": 0})
...
def test_borrow_limit_exceeded_over_5(mocker):
    ...
    mocker.patch("library_service.get_book_by_id", return_value={"id": 1, "title": "1984", "available_copies": 1})
